...
const Savings = () => {
  ...
  return (
    <div className="flex flex-col md:flex-row items-center md:items-start justify-center md:gap-16 lg:gap-40">
      <div className="max-w-sm md:max-w-xl flex flex-col items-center justify-center gap-4 p-4">
        <Penghasilan
